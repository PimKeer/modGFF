...
Nk = 1000 # Amount of samples made for the average of gamma.
...
for i in range(len(Narr)):
    ...
    for a in aarr:
        for b in barr:
            wx1, wy1, wz1 = wxyz(N,b,b) # Set checkerboard conductances
            wx2, wy2, wz2 = wxyz(2*N,b,b) # Set checkerboard conductances
            ...
            for j in range(Np):
                ...
                np.save('checkerboard_'+str(a)+'_'+str(p)+'.npy', y1arr)
                np.save('checkerboard_'+str(a)+'_'+str(p)+'.npy', y2arr)
